...
int main(int argc, char *argv[])
{
    ...
    printf("Copying from index %d to %d, total nbr of element is : %d, and size is : %d", arrStart[world_rank], arrEnd[world_rank], splittedLengthes[world_rank], splittedSizes[world_rank]);
